...
-- Created: Sun May 17 18:42:08 2020
...
-- Schema Comics
-- ----------------------------------------------------------------------------
DROP SCHEMA IF EXISTS `endles38_comics` ;
CREATE SCHEMA IF NOT EXISTS `endles38_comics` ;

-- ----------------------------------------------------------------------------
-- Table Comics.Files
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`Files` (
  `FileID` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`sysdiagrams` (
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`SystemSettings` (
...
CREATE TABLE IF NOT EXISTS `endles38_comics`.`StoryArcs` (
  ...
  CONSTRAINT `FK_StoryArcs_StoryLines`
    ...
    REFERENCES `endles38_comics`.`StoryLines` (`StoryLineID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- Table Comics.Images
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`Images` (
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`PageImages` (
  ...
  CONSTRAINT `FK_PageImages_Images`
    FOREIGN KEY (`ImageID`)
    REFERENCES `endles38_comics`.`Images` (`ImageID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_PageImages_Pages`
    FOREIGN KEY (`PageID`)
    REFERENCES `endles38_comics`.`Pages` (`PageID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`LibraryFolders` (
...
-- Table Comics.Issues
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`Issues` (
  ...
  CONSTRAINT `FK_Issues_Series`
    ...
    REFERENCES `endles38_comics`.`Series` (`SeriesID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`StoryLines` (
  `StoryLineID` INT NOT NULL,
...
-- Table Comics.Series
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`Series` (
  `SeriesID` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`PageStoryArcs` (
  ...
  CONSTRAINT `FK_PageStoryArcs_StoryArcs`
    ...
    REFERENCES `endles38_comics`.`StoryArcs` (`StoryArcID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table Comics.Pages
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `endles38_comics`.`Pages` (
  `PageID` INT NOT NULL,
  `IssueID` INT NOT NULL,
  ...
  CONSTRAINT `FK_Pages_Issues`
    FOREIGN KEY (`IssueID`)
    REFERENCES `endles38_comics`.`Issues` (`IssueID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
